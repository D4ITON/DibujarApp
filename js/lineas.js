...
class Linea {
	...
	dibujarLineaDirecto() 
	{
		let xi = this.xinicial;
		let yi = this.yinicial;
		let xf = this.xfinal;
		let yf = this.yfinal;
...
// clase circulo
class Circulo {
	constructor(xcentral,ycentral,radio){
		this.xcentral = xcentral;
		this.ycentral = ycentral;
		this.radio = radio;
	}
	//representacion implicita
	dibujarCirculoImplicita()
	{
		let xc = this.xcentral;
		let yc = this.ycentral;
		let r = this.radio;
